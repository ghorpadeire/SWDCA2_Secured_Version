            ...
            <div class="row">
                <div class="col-4 border border-success">
                    <center>
                        ...
                        <h3>
                        <?php 
                        $sql= "SELECT * FROM user where role='Donor' or role='Recipient'";
                ...
                <div class="col-4 border border-success">
                    <center>
                        ...
                        <h3>
                        <?php 
                        $sql= "SELECT * FROM user where role='Donor'";
                        $result=mysqli_query($conn,$sql);
                        $rowcount=mysqli_num_rows($result);
                        ...
                        <h5 class="text-muted">Donor</h5>
                    </center>
                </div>
                <div class="col-4 border border-success">
                    <center>
                        <svg style="color: rgb(255, 0, 183);" xmlns="http://www.w3.org/2000/svg" width="50" height="50"
                        ...
                        <h5 class="text-muted">Reciept</h5>
                    </center>
                </div>
            ...
            <div class="row">
                <div class="col-4 border border-success">
                    <center>
                        ...
                        <?php 
                        $sql="SELECT sum(ramount) FROM need";
                        $result=mysqli_query($conn,$sql);
         while ($row=mysqli_fetch_array($result)){
             ...
             <h3><?=$rfund ?></h3>
                ...
                <div class="col-4 border border-success">
                    <center>
                        ...
                        <?php 
                        $sql="SELECT sum(hamount) FROM help";
                        $result=mysqli_query($conn,$sql);
         while ($row=mysqli_fetch_array($result)){
