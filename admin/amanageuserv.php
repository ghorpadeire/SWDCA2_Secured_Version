        ...
        <div class="col-9 vh-100 overflow-auto">
            ...
            <div class="row">
                <table class="table table-hover" style="font-size: 15px;">
                    ...
                    <tbody>
                    <?php
          $query="select * from user where role='Donor' or role='Recipient'";
          $result=mysqli_query($conn,$query);
         while ($row=mysqli_fetch_array($result)){ ?>
                        <tr>
                            ...
                            <input type='hidden' value=<?= $row['id']; ?> name='uid'>
                                ...
                                <td> <button
                                            ...
                                            name="smubtn"><svg style="color: rgb(0, 68, 255);"
                                ...
                                <td><button style="border:none; background-color:transparent;" type="submit"
                                        name="dmubtn"><svg style="color: red;" xmlns="http://www.w3.org/2000/svg"
