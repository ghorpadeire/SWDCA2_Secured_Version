                ...
                <table class="table table-hover" style="font-size: 15px;">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th scope="col" style="width:20%;">E_amount</th>
                            <th>Datails</th>
                            <th>Action</th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php
          $query="select * from need where status='0'";
          $result=mysqli_query($conn,$query);
         while ($row=mysqli_fetch_array($result)){ ?>
                        <tr>
                            ...
                            <input type='hidden' value=<?php echo $aid; ?> name='did'>
                                <th scope="row"><?= $row['id']; ?></th>
                                <td><?= $row['ntype']; ?></td>
                                <td><?= $row['ndetails']; ?></td>
                                <td><?= $row['ramount']; ?></td>
                                <td><input type="text" class="form-control" placeholder="Enter amount" name="hamount"></td>
                                <td><button
                                            style="border:none; background-color:transparent;" type="submit"
                                            name="shdbtn"><svg style="color: rgb(0, 68, 255);"
                                ...
                                <td><button
                                            style="border:none; background-color:transparent;" type="submit"
                                            name="ah"><svg style="color: darkgreen;" xmlns="http://www.w3.org/2000/svg"
