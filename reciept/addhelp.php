    ...
    <div class="row">
        ...
        <div class="col-9 vh-100 overflow-auto">
            <h6><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <input type='hidden' value=<?= $aid ?> name='rid'>
              <div class="row">
                  <div class="col-6 ">
         ...
         while ($row=mysqli_fetch_array($result)){ 
             ?>
                  ...
                  <div class="col-6 ">
                      <label for="formFile" class="form-label">Upload Need Photo</label>
                      <input class="form-control" type="file" id="formFile" name="nphoto">
                  </div>
              </div>
              <div class="row">
                  <div class="col-6">
                  <div class="form-floating ">
                          <input type="text" class="form-control" id="floatingInput" name="nname">
                          <label for="floatingInput">Enter need Name</label>
                      </div>
                  </div>
                  <div class="col-6">
                  <div class="form-floating ">
                          <textarea class="form-control" id="floatingInput" placeholder="name@example.com"
                              name="ndetail" rows="1"></textarea>
                          <label for="floatingInput">Enter Need Description</label>
                      </div>
                  </div>
              </div>
              <div class="row">
                  <div class="col-6">
                      <div class="form-floating ">
                          <input type="text" class="form-control" id="floatingInput" name="ramount">
                          <label for="floatingInput">Enter Amount We needed</label>
                      </div>
                  </div>
                  <div class="col-6">
                      <label for="formFile" class="form-label">Select last date</label>
                      <input type="datetime-local" id="birthdaytime" name="ldate" class="form-control">
                  </div>
              </div>
              <div class="row">
                  <div class="col-12">
