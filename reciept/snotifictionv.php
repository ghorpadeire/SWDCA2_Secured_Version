...
<body>
    ...
    <div class="row">
        ...
        <div class="col-9 vh-100 overflow-auto">
            ...
            <?php } ?> 
                    <td><?= $row['hamount']; ?></td>
                                <td><input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Enter message" name="message"></td>
                                <td><button
                                            style="border:none; background-color:transparent;" type="submit"
                                            name="srbtn"><svg style="color: rgb(0, 68, 255);"
                                ...
                                <td><button
                                            style="border:none; background-color:transparent;" type="submit"
                                            name="srtd"><svg style="color: darkgreen;" xmlns="http://www.w3.org/2000/svg"
    ...
    <!-- Modal for view User datails -->
    <div class="modal fade" id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel2" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">View User Details</h5>
